...
setuptools.setup(
    ...
    license="MIT",
    description="a library for creating textural features for satellite images",
    keywords="python gis geography image settlement texture",
